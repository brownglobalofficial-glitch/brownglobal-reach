...
export default function App(){
  ...
  return <main>
    <header className="topbar"><a className="wordmark" href="#top"><img src="/reach-logo.svg" alt="BrownGlobal Reach logo"/><span>BrownGlobal <b>Reach</b></span></a><nav><a href="#network">Opportunities</a><a href="#process">How it works</a><a href="#standards">Standards</a><a href="#plans">Plans</a></nav><div className="account-actions"><a className="button dark small" href="#planner">Plan a campaign <span>&nearr;</span></a><button className={"account-button " + (session ? "signed" : "")} onClick={session ? signOut : () => setAuthOpen(true)}>{session ? "Sign out" : "Sign up"}</button></div></header>
    <section className="hero" id="top"><div className="hero-copy"><span className="eyebrow"><i/>Direct advertising & sponsorships</span><h1>Put your brand in the <em>right moments.</em></h1><p>Plan thoughtful campaigns across sports, streaming, publishing and BrownGlobal-owned experiences&mdash;with a real team reviewing every placement.</p><div className="actions"><a className="button primary" href="#planner">Build a campaign <span>&rarr;</span></a><a className="text-link" href="mailto:admin@brownglobal.app?subject=BrownGlobal%20Reach%20media%20kit">Request the media kit &nearr;</a></div></div><div className="campaign-card"><div className="campaign-head"><span>CAMPAIGN 01</span><b>Community in motion.</b><span>PLANNING</span></div><div className="campaign-visual"><div className="rings"><i/><i/><i/></div><strong>REACH<br/>THE<br/>MOMENT.</strong><span>GSN &times; WAVE</span></div><div className="campaign-foot"><div><small>OBJECTIVE</small><b>Awareness</b></div><div><small>PLACEMENTS</small><b>04</b></div><div><small>REVIEW</small><b>Human-led</b></div></div></div></section>
    ...
    <section className="business" id="business"><div className="business-mark"><img src="/brownglobal-icon.svg" alt=""/><small>BROWNGLOBAL<br/>BUSINESS</small></div><div><span className="eyebrow"><i/>Connected to Studio</span><h2>Campaigns are one part of the business.</h2><p>Organize your team, content and BrownGlobal products in Studio. BrownGlobal Business will connect eligible Studio, Flow and Reach benefits while every platform remains available separately.</p></div><a className="button outline" href="mailto:admin@brownglobal.app?subject=BrownGlobal%20Business">Ask about Business <span>&nearr;</span></a></section>
    <section className="plans" id="plans"><div className="plans-header"><span className="eyebrow"><i/>Simple membership</span><h2>Start free. Add Business when the team grows.</h2><p>Every BrownGlobal product should remain useful on its own. Business adds shared capabilities across eligible products.</p></div><div className="plan-grid"><article className="plan-card"><small>FREE</small><h3>$0</h3><p>For individuals and small organizations getting started.</p><ul><li>One BrownGlobal account</li><li>Campaign planner and saved requests</li><li>Access to each product's core tools</li><li>Standard support</li></ul></article><article className="plan-card business-plan"><small>BROWNGLOBAL BUSINESS</small><h3>One membership</h3><p>Pricing will be announced before paid enrollment opens.</p><ul><li>Team members and managed roles</li><li>Shared brand library and reusable templates</li><li>Expanded projects and cross-product organization</li><li>Priority Reach planning and support</li></ul></article></div></section>
